    ...
    <section id="personal" className="mx-auto max-w-7xl px-5 py-16 lg:px-8">
      ...
      <div className="grid gap-5 lg:grid-cols-[1.2fr_0.8fr]">
        <div className="rounded-[1.75rem] border border-slate-800 bg-slate-900/70 p-6">
          ...
          <p className="text-lg leading-8 text-slate-400">I grew up in Mumbai, India, surrounded by engineering, entrepreneurship, and a strong bias toward building. That foundation shaped how I approach design: not only making something work, but making it manufacturable, reliable, and ready to scale.</p>
        </div>
        <div className="rounded-[1.75rem] border border-slate-800 bg-slate-900/70 p-6">
