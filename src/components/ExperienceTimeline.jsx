              ...
              <div className={classNames("grid gap-6 rounded-3xl border p-6 lg:grid-cols-[0.72fr_1.28fr]", darkMode ? "border-slate-800 bg-slate-900/70" : "border-slate-200 bg-white")}>
                ...
                <div>
                  <div className="mb-4 flex flex-col justify-between gap-3 lg:flex-row lg:items-start">
                    <div>
                      <p className={classNames("text-xs font-semibold uppercase tracking-[0.22em]", darkMode ? "text-sky-300" : "text-sky-700")}>{item.theme}</p>
                      <h3 className="mt-2 text-2xl font-semibold tracking-tight">{item.company}</h3>
                      <p className={classNames("mt-1", darkMode ? "text-slate-300" : "text-slate-700")}>{item.role}</p>
                    </div>
