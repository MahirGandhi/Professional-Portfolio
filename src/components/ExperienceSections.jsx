...
function SupportingExperienceCard({ item, darkMode }) {
  ...
  return (
    <article className={classNames("rounded-3xl border p-5", panelClass)}>
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <h4 className="mt-2 text-lg font-semibold tracking-tight">{item.company}</h4>
      ...
      {supportingExperience.length > 0 && (
        <div className="mt-10">
          <div className="mb-5">
            ...
            <h3 className="text-xl font-semibold tracking-tight">Hardware, research, and systems work</h3>
          </div>
